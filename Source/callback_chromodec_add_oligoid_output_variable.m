...
experimentId = callback_chromodec_find_output_variable(bez_code, 'Experiment');
microscopeId = callback_chromodec_find_output_variable(bez_code, 'Microscope');
positionId = callback_chromodec_find_output_variable(bez_code, 'Position');

%% check if the oligoID output variable already exists to avoid creating another one
newOutputVariable = callback_chromodec_find_output_variable(bez_code, 'OligoID');
