...
parameters.manuallyConfirmedFeature = callback_livecellminer_find_single_feature(dorgbez, 'manuallyConfirmed');
...
set(parameters.mainFigure, 'WindowButtonDownFcn', @callback_livecellminer_clickEventHandler);
set(parameters.mainFigure, 'WindowScrollWheelFcn', @callback_livecellminer_scrollEventHandler);
set(parameters.mainFigure, 'KeyReleaseFcn', @callback_livecellminer_keyReleaseEventHandler);
