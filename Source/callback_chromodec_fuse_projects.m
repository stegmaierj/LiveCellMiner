...
[inputFolders, microscopeList, experimentList, positionList] = callback_chromodec_get_valid_input_paths(inputRootFolder);
...
for i=1:length(inputFolders)
    ...
    [microscopeId, experimentId, positionId] = callback_chromodec_get_output_variables(microscopeList, experimentList, positionList, microscopeName, experimentName, positionName);
