...
function [microscopeId, experimentId, positionId] = callback_chromodec_get_output_variables(microscopeList, experimentList, positionList, microscopeName, experimentName, positionName)
