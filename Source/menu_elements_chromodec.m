...
function elements = menu_elements_chromodec(parameter)
% function elements = menu_elements_chromodec(parameter)
%
% 
% 
%
% The function optionen_felder_chromodec is part of the MATLAB toolbox SciXMiner. 
...
elements(mc).callback = 'callback_chromodec_set_external_dependencies;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_batch_processing;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_fuse_projects;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_load_image_files;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_perform_auto_sync;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_find_invalid_synchronization_indices;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_show_auto_sync_overview;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_manual_synchronization_gui;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_update_auto_sync_classifier;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'visualizationMode = 1; callback_chromodec_show_heatmaps;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'visualizationMode = 2; callback_chromodec_show_heatmaps;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'visualizationMode = 2; callback_chromodec_show_combined_plots;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'showHistogram = false; callback_chromodec_show_combined_boxplots;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'showHistogram = true; callback_chromodec_show_combined_boxplots;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_normalize_selected_time_series;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_smooth_features;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_compute_linear_regression_slope;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_compute_relative_recovery_time_series;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_compute_additional_single_features;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_add_oligoid_output_variable;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_add_combined_experiment_output_variable;';
...
elements(mc).delete_pointerstatus = 0;
elements(mc).callback = 'callback_chromodec_select_based_on_single_feature_range;';
