...
function featureId = callback_livecellminer_find_time_series(var_bez, featureName)
    ...
    if (featureId == 0)
       disp(['Desired time series ' featureName ' was not found! The search is case sensitive!']);
    end
end