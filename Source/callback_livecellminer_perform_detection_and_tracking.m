...
function [] = callback_livecellminer_perform_detection_and_tracking(parameters)
    ...
    elseif (strcmp(parameters.trackingMethod, 'Ultrack'))
        ...
        currentFileDir = strrep(currentFileDir, '\', '/');
        ...
        pythonCommand = [parameters.ULTRACKPath ...
                         ...
                         ' --min_area ' num2str(parameters.minNucleusAreaPixel) ...
                         ' --max_area ' num2str(parameters.maxNucleusAreaPixel) ...
                         ' --max_distance ' num2str(parameters.maxLinkingDistancePixel) ...
                         overwriteTracking];
