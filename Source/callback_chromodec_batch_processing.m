...
if (exist(settingsFile, 'file'))
    ...
    callback_chromodec_set_external_dependencies;
end
...
for i=1:length(inputFolders)
    ...
    [~, filesExist] = callback_chromodec_generate_output_paths(parameters);
    if (~filesExist.project || ...
        ...
        callback_chromodec_import_project(parameters);
    else
