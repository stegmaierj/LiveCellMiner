...
function [microscopeId, experimentId, positionId] = callback_chromatindec_get_output_variables(microscopeList, experimentList, positionList, microscopeName, experimentName, positionName)
